...
public class AdaptadorListaMaterias extends RecyclerView.Adapter<AdaptadorListaMaterias.MateriaHolder>{
    ...
    public void onBindViewHolder(AdaptadorListaMaterias.MateriaHolder holder, int position) {
        holder.txtMateriaReg.setText( String.valueOf(lista_materias.get(position).getNombre_materia()));
        holder.txtNrcReg.setText( String.valueOf(lista_materias.get(position).getNrc()));
    ...
    public class MateriaHolder extends RecyclerView.ViewHolder {
        ...
        CardView listMat;
        TextView txtMateriaReg, txtNrcReg;
        View view;

        public MateriaHolder(View itemView) {
            super(itemView);
            txtMateriaReg=itemView.findViewById(R.id.txtMateriaReg);
            txtNrcReg=itemView.findViewById(R.id.txtNrcReg);
            view = itemView;
        }
